...
pub struct CreateAccountArgs {
    ...
    #[clap(long, aliases = ["public_key", "publicKey"], default_value = None)]
    public_key: Option<String>,
    #[clap(long, aliases = ["new_ledger_key", "newLedgerKey"], default_value = "44'/397'/0'/0'/1'")]
    new_ledger_key: String,
