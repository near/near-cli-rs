    ...
    if offline_mode {
        tracing::warn!(
            ...
            crate::common::indent_payload(&format!("\n{}",
                format!("The transaction will be created with only the ft_transfer action\nwithout checking whether the ft-contrat account is registered on the <{}> network.\nMake sure that you have enough funds in your account to cover both the ft_transfer action and\nthe deposit if the recipient account is not registered on ft-contract <{}>.",
