...
mod add_action_level;
pub mod skip_action;
pub mod state_init_receiver;

use add_action_level::impl_add_action_level;
use strum::{EnumDiscriminants, EnumIter, EnumMessage};

// The chain of actions is a linked list of `NextAction` subcommands bounded at
// compile time (clap cannot express recursive subcommands), so each level of
// the chain is generated by the `impl_add_action_level!` macro and wired to
// the next one. The last level points to `add_action_last`, which only allows
// skipping to transaction signing. To change the maximum number of actions per
// transaction, add or remove levels here.
impl_add_action_level!(add_action_1, add_action_2);
impl_add_action_level!(add_action_2, add_action_3);
impl_add_action_level!(add_action_3, add_action_4);
impl_add_action_level!(add_action_4, add_action_5);
impl_add_action_level!(add_action_5, add_action_6);
impl_add_action_level!(add_action_6, add_action_7);
impl_add_action_level!(add_action_7, add_action_8);
impl_add_action_level!(add_action_8, add_action_9);
impl_add_action_level!(add_action_9, add_action_10);
impl_add_action_level!(add_action_10, add_action_last);
